...
dc_args=(
  ...
  -e DOCLING_INCLUDE_PICTURES
  -e DOCLING_DO_PICTURE_CLASSIFICATION
  -e DOCLING_DO_PICTURE_DESCRIPTION
  -e DOCLING_OCR_AUTO
  -e DOCLING_OCR_AUTO_TEXT_LAYER_THRESHOLD
  -e DOCLING_OCR_AUTO_MIN_CHARS
  -e DOCLING_OCR_AUTO_SAMPLE_PAGES
  -e PDF_DUMP_DIR
  -e INPUT_PDF_PATH
)
...
DOCLING_OCR_AUTO_TEXT_LAYER_THRESHOLD="${DOCLING_OCR_AUTO_TEXT_LAYER_THRESHOLD:-0.95}" \
